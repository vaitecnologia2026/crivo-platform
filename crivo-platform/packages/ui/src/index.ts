// @crivo/ui — CRIVO™ Design System (fonte única de verdade)
export { cn } from "./lib/utils";
export { Vertice, type VerticeProps } from "./components/vertice";
export { Brand, type BrandProps } from "./components/brand";
