...
| R10 | Custo de reescrever frontend estático em config-driven | 🟡 Médio | Migração incremental (em curso: 5/9 telas viraram ilhas React+API — Dashboard, ICD, CRM, Questionário, Campanhas) |
