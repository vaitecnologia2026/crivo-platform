  ...
  <div id="app" class="screen screen--app">
    ...
    <main class="main">
      ...
      <section class="route is-active" data-route="dashboard">
        <div class="route__head">
          <div>
            ...
            <p class="page-sub">Como sua empresa está performando em saúde organizacional e liderança hoje.</p>
          </div>
          <div class="route__actions">
            <div class="select-pill"><span>Período</span><strong>Últimos 90 dias ▾</strong></div>
            <button class="btn btn--outline-dark btn--sm">Exportar relatório</button>
          </div>
        </div>
        ...
        <div class="kpi-grid">
          <div class="kpi">
            <span class="kpi__label">ICD Geral</span>
            <strong class="kpi__value">87</strong>
            <span class="kpi__delta kpi__delta--up">▲ 6 pts vs trimestre anterior</span>
            <div class="kpi__bar"><div style="width: 87%"></div></div>
          </div>
          <div class="kpi">
            <span class="kpi__label">Conformidade NR1</span>
            <strong class="kpi__value">92<small>%</small></strong>
            <span class="kpi__delta kpi__delta--up">▲ 4% — em conformidade</span>
            <div class="kpi__bar"><div style="width: 92%"></div></div>
          </div>
          <div class="kpi">
            <span class="kpi__label">Turnover voluntário</span>
            <strong class="kpi__value">8.4<small>%</small></strong>
            <span class="kpi__delta kpi__delta--down">▼ 23% vs ano anterior</span>
            <div class="kpi__bar kpi__bar--alt"><div style="width: 35%"></div></div>
          </div>
          <div class="kpi">
            <span class="kpi__label">Clima organizacional</span>
            <strong class="kpi__value">4.2<small>/5</small></strong>
            <span class="kpi__delta kpi__delta--up">▲ 0.3 vs último ciclo</span>
            <div class="kpi__bar"><div style="width: 84%"></div></div>
          </div>
        </div>
        ...
        <div class="grid grid--2">
          <div class="card">
            <div class="card__head">
              <div>
                ...
                <span class="card__sub">Coerência decisória mês a mês</span>
              </div>
              <div class="legend">
                <span class="legend__item"><i style="background: var(--gold)"></i>ICD</span>
                <span class="legend__item"><i style="background: var(--line)"></i>Benchmark</span>
              </div>
            </div>
              ...
              <svg viewBox="0 0 600 200" preserveAspectRatio="none">
                <defs>
                  <linearGradient id="grad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stop-color="rgba(168, 105, 61, 0.3)"/>
                    <stop offset="100%" stop-color="rgba(168, 105, 61, 0)"/>
                  </linearGradient>
                </defs>
                <path d="M 0 160 L 100 140 L 200 130 L 300 110 L 400 85 L 500 70 L 600 50 L 600 200 L 0 200 Z" fill="url(#grad)" />
                <path d="M 0 160 L 100 140 L 200 130 L 300 110 L 400 85 L 500 70 L 600 50" fill="none" stroke="#C4894A" stroke-width="2.5" />
                <path d="M 0 170 L 100 165 L 200 162 L 300 160 L 400 155 L 500 152 L 600 148" fill="none" stroke="#B8C4D0" stroke-width="1.5" stroke-dasharray="4 4" />
                <circle cx="600" cy="50" r="5" fill="#C4894A" />
              </svg>
              <div class="line-chart__x">
          ...
          <div class="card">
            <div class="card__head">
              <div>
                <h3>Riscos psicossociais por área</h3>
                <span class="card__sub">Distribuição de risco identificado</span>
              </div>
            </div>
            <div class="bars">
              <div class="bar-row">
                <span class="bar-row__label">Operações</span>
                <div class="bar"><div class="bar__fill bar__fill--high" style="width: 78%"></div></div>
                <span class="bar-row__value">78</span>
              </div>
              <div class="bar-row">
                <span class="bar-row__label">Comercial</span>
                <div class="bar"><div class="bar__fill bar__fill--high" style="width: 71%"></div></div>
                <span class="bar-row__value">71</span>
              </div>
              <div class="bar-row">
                <span class="bar-row__label">Financeiro</span>
                <div class="bar"><div class="bar__fill bar__fill--mid" style="width: 54%"></div></div>
                <span class="bar-row__value">54</span>
              </div>
              <div class="bar-row">
                <span class="bar-row__label">Tecnologia</span>
                <div class="bar"><div class="bar__fill bar__fill--mid" style="width: 46%"></div></div>
                <span class="bar-row__value">46</span>
              </div>
              <div class="bar-row">
                <span class="bar-row__label">Marketing</span>
                <div class="bar"><div class="bar__fill bar__fill--low" style="width: 32%"></div></div>
                <span class="bar-row__value">32</span>
              </div>
              <div class="bar-row">
                <span class="bar-row__label">RH</span>
                <div class="bar"><div class="bar__fill bar__fill--low" style="width: 24%"></div></div>
                <span class="bar-row__value">24</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid--2">
          <div class="card">
            <div class="card__head">
              <div>
                ...
                <span class="card__sub">Pontos que precisam de atenção esta semana</span>
              </div>
              <span class="pill pill--danger">3 abertos</span>
            </div>
            <ul class="alerts">
              <li class="alert">
                <span class="alert__dot alert__dot--danger"></span>
                <div>
                  <strong>Pressão alta em Operações — Turno B</strong>
                  <span>32 colaboradores apontam sobrecarga sustentada nos últimos 21 dias.</span>
                </div>
                <button class="btn btn--ghost-dark btn--sm">Ver plano</button>
              </li>
              <li class="alert">
                <span class="alert__dot alert__dot--warn"></span>
                <div>
                  <strong>Líder com ICD em queda</strong>
                  <span>Carla Antunes (Comercial) caiu 12 pts no último ciclo. Recomendado: mentoria 1-on-1.</span>
                </div>
                <button class="btn btn--ghost-dark btn--sm">Ver plano</button>
              </li>
              <li class="alert">
                <span class="alert__dot alert__dot--warn"></span>
                <div>
                  <strong>Cluster de afastamentos</strong>
                  <span>Setor Financeiro: 4 afastamentos por saúde mental nos últimos 60 dias.</span>
                </div>
                <button class="btn btn--ghost-dark btn--sm">Ver plano</button>
              </li>
            </ul>
          ...
          <div class="card">
            <div class="card__head">
              <div>
                <h3>Líderes em destaque</h3>
                <span class="card__sub">Top performers em coerência decisória</span>
              </div>
              <a href="#" class="link-gold link-gold--sm" data-route-link="icd">Ver ranking completo →</a>
            </div>
            <ul class="leaders">
              <li class="leader">
                <span class="leader__avatar" style="background: #2E4D7A">MS</span>
                <div class="leader__info">
                  <strong>Marina Souza</strong>
                  <span>Diretora · Tecnologia</span>
                </div>
                <div class="leader__score"><strong>94</strong><span>ICD</span></div>
                <span class="leader__trend up">▲</span>
              </li>
              <li class="leader">
                <span class="leader__avatar" style="background: #A8693D">RC</span>
                <div class="leader__info">
                  <strong>Ricardo Campos</strong>
                  <span>Head · Operações</span>
                </div>
                <div class="leader__score"><strong>91</strong><span>ICD</span></div>
                <span class="leader__trend up">▲</span>
              </li>
              <li class="leader">
                <span class="leader__avatar" style="background: #4A6FA5">JF</span>
                <div class="leader__info">
                  <strong>Júlia Ferreira</strong>
                  <span>Gerente · Comercial</span>
                </div>
                <div class="leader__score"><strong>89</strong><span>ICD</span></div>
                <span class="leader__trend up">▲</span>
              </li>
              <li class="leader">
                <span class="leader__avatar" style="background: #1B3A6B">PL</span>
                <div class="leader__info">
                  <strong>Pedro Lima</strong>
                  <span>Coordenador · Financeiro</span>
                </div>
                <div class="leader__score"><strong>86</strong><span>ICD</span></div>
                <span class="leader__trend flat">▬</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section class="route" data-route="icd">
        <div class="route__head">
          <div>
            <h1 class="page-title">Índice de Coerência Decisória</h1>
            <p class="page-sub">A qualidade do estado decisório da liderança — em cinco dimensões.</p>
          </div>
          <div class="route__actions">
            <div class="select-pill"><span>Cohort</span><strong>Toda a liderança ▾</strong></div>
            <button class="btn btn--gold btn--sm">Aplicar novo ciclo</button>
          </div>
        </div>

        <div class="grid grid--icd">
          <div class="card card--icd-radar">
            <h3>Radar de Coerência Decisória</h3>
            <div class="radar-pro">
              <svg viewBox="-80 0 560 400">
                <!-- Rings (pentágono · 5 dimensões) -->
                <polygon points="200,40 352,151 294,329 106,329 48,151" fill="none" stroke="rgba(168,105,61,0.16)" />
                <polygon points="200,90 305,166 265,289 135,289 95,166" fill="none" stroke="rgba(168,105,61,0.22)" />
                <polygon points="200,140 257,182 235,249 165,249 143,182" fill="none" stroke="rgba(168,105,61,0.3)" />
                <line x1="200" y1="200" x2="200" y2="40" stroke="rgba(13,31,60,0.08)" />
                <line x1="200" y1="200" x2="352" y2="151" stroke="rgba(13,31,60,0.08)" />
                <line x1="200" y1="200" x2="294" y2="329" stroke="rgba(13,31,60,0.08)" />
                <line x1="200" y1="200" x2="106" y2="329" stroke="rgba(13,31,60,0.08)" />
                <line x1="200" y1="200" x2="48" y2="151" stroke="rgba(13,31,60,0.08)" />
                <polygon points="200,59 308,165 279,309 126,302 84,162" fill="rgba(168,105,61,0.22)" stroke="#C4894A" stroke-width="2" />
                <circle cx="200" cy="59" r="5" fill="#C4894A" />
                <circle cx="308" cy="165" r="5" fill="#C4894A" />
                <circle cx="279" cy="309" r="5" fill="#C4894A" />
                <circle cx="126" cy="302" r="5" fill="#C4894A" />
                <circle cx="84" cy="162" r="5" fill="#C4894A" />
                <text x="200" y="28" text-anchor="middle" fill="#0D1F3C" font-size="12" font-weight="600">CLAREZA · 88</text>
                <text x="360" y="150" text-anchor="start" fill="#0D1F3C" font-size="12" font-weight="600">PRESSÃO · 71</text>
                <text x="298" y="352" text-anchor="start" fill="#0D1F3C" font-size="12" font-weight="600">CONFIANÇA · 84</text>
                <text x="102" y="352" text-anchor="end" fill="#0D1F3C" font-size="12" font-weight="600">INFLUÊNCIA · 79</text>
                <text x="42" y="150" text-anchor="end" fill="#0D1F3C" font-size="12" font-weight="600">RISCO/AÇÃO · 76</text>
              </svg>
            </div>
          </div>
          ...
          <div class="icd-side">
            <div class="card card--feature">
              <span class="card__eyebrow">ICD MÉDIO</span>
              <strong class="big-num">80<small>/100</small></strong>
              <span class="card__hint">Acima do benchmark do setor (73)</span>
              <div class="kpi__bar"><div style="width: 80%"></div></div>
            </div>

            <div class="card card--pattern">
              <span class="card__eyebrow">PADRÃO DOMINANTE</span>
              <strong class="pattern-label">Pressão</strong>
              <span class="card__hint">O driver que mais governa as decisões da liderança hoje. Alternativas: Autoimagem · Conformidade · Ameaça.</span>
            </div>
            ...
            <div class="card">
              ...
              <ul class="ai-recs">
                <li>
                  <span class="ai-recs__ic">▴</span>
                  <div>
                    <strong>Trabalhar a dimensão Pressão</strong>
                    <span>Menor score (71) e padrão dominante. Workshop de liderança sob pressão para a operação.</span>
                  </div>
                </li>
                <li>
                  <span class="ai-recs__ic">▴</span>
                  <div>
                    <strong>Mentoria individual</strong>
                    <span>3 líderes 15+ pts abaixo da média. Plano 1-on-1 de 90 dias com devolutiva estruturada.</span>
                  </div>
                </li>
                <li>
                  <span class="ai-recs__ic">▴</span>
                  <div>
                    <strong>Reaplicar ciclo em 60 dias</strong>
                    <span>Janela ideal para medir o efeito das ações sobre o ICD.</span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div class="card">
          <div class="card__head">
            <div>
              ...
              <span class="card__sub">Coerência decisória individual — clique para abrir o perfil</span>
            </div>
            <input type="text" class="search-inline" placeholder="Filtrar por nome ou área..." />
          </div>
          <table class="data-table">
            <thead>
              <tr><th>Líder</th><th>Área</th><th>Clareza</th><th>Pressão</th><th>Confiança</th><th>Influência</th><th>Risco/Ação</th><th>ICD</th><th>Padrão</th></tr>
            </thead>
            <tbody>
              <tr>
                <td><strong>Marina Souza</strong></td><td>Tecnologia</td>
                <td>96</td><td>89</td><td>94</td><td>92</td><td>95</td>
                <td><span class="score-pill score-pill--high">94</span></td>
                <td><span class="pattern-tag">Confiança</span></td>
              </tr>
              <tr>
                <td><strong>Ricardo Campos</strong></td><td>Operações</td>
                <td>92</td><td>84</td><td>93</td><td>91</td><td>90</td>
                <td><span class="score-pill score-pill--high">91</span></td>
                <td><span class="pattern-tag">Confiança</span></td>
              </tr>
              <tr>
                <td><strong>Júlia Ferreira</strong></td><td>Comercial</td>
                <td>90</td><td>82</td><td>88</td><td>92</td><td>89</td>
                <td><span class="score-pill score-pill--high">89</span></td>
                <td><span class="pattern-tag">Influência</span></td>
              </tr>
              <tr>
                <td><strong>Pedro Lima</strong></td><td>Financeiro</td>
                <td>88</td><td>78</td><td>85</td><td>84</td><td>86</td>
                <td><span class="score-pill score-pill--mid">84</span></td>
                <td><span class="pattern-tag">Conformidade</span></td>
              </tr>
              <tr>
                <td><strong>Ana Beatriz</strong></td><td>Marketing</td>
                <td>84</td><td>74</td><td>80</td><td>82</td><td>78</td>
                <td><span class="score-pill score-pill--mid">80</span></td>
                <td><span class="pattern-tag">Autoimagem</span></td>
              </tr>
              <tr>
                <td><strong>Carla Antunes</strong></td><td>Comercial</td>
                <td>74</td><td>58</td><td>68</td><td>70</td><td>64</td>
                <td><span class="score-pill score-pill--low">66</span></td>
                <td><span class="pattern-tag pattern-tag--alert">Pressão</span></td>
              </tr>
              <tr>
                <td><strong>Lucas Tavares</strong></td><td>Operações</td>
                <td>72</td><td>60</td><td>70</td><td>65</td><td>68</td>
                <td><span class="score-pill score-pill--low">67</span></td>
                <td><span class="pattern-tag pattern-tag--alert">Ameaça</span></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section class="route" data-route="questionario">
        <div class="route__head">
          <div>
            <h1 class="page-title">Questionário NR1 — Riscos Psicossociais</h1>
            <p class="page-sub">Aplicação estruturada · Suas respostas são confidenciais e anônimas.</p>
          </div>
          <div class="route__actions">
            <span class="pill">Ciclo 2026.Q2</span>
          </div>
        </div>

        <div class="card card--quiz">
          <div class="quiz__progress">
            <div class="quiz__bar"><div class="quiz__bar-fill" style="width: 28%"></div></div>
            <span class="quiz__step">Pergunta 7 de 25 · Dimensão: <strong>Demandas de Trabalho</strong></span>
          </div>

          <div class="quiz__body">
            <span class="quiz__num">07</span>
            <h2 class="quiz__q">Com que frequência você precisa trabalhar em ritmo acelerado para conseguir cumprir as tarefas do dia?</h2>
            <p class="quiz__help">Considere as últimas 4 semanas.</p>

            <div class="likert">
              <label class="likert__opt">
                <input type="radio" name="q7" />
                <span class="likert__circle"></span>
                <strong>Nunca</strong>
                <em>O ritmo é tranquilo</em>
              </label>
              <label class="likert__opt">
                <input type="radio" name="q7" />
                <span class="likert__circle"></span>
              ...
              <label class="likert__opt is-selected">
                <input type="radio" name="q7" checked />
                <span class="likert__circle"></span>
                <strong>Às vezes</strong>
                <em>Em algumas semanas</em>
              </label>
              <label class="likert__opt">
                <input type="radio" name="q7" />
                <span class="likert__circle"></span>
                <strong>Frequentemente</strong>
                <em>Na maioria dos dias</em>
              </label>
              <label class="likert__opt">
                <input type="radio" name="q7" />
                <span class="likert__circle"></span>
          ...
          <div class="quiz__nav">
            ...
            <div class="quiz__indicator">7 / 25</div>
            <button class="btn btn--gold">Próxima →</button>
          </div>
        </div>

        <div class="grid grid--3 grid--mini">
          <div class="mini-card">
            <span class="mini-card__ic">🔒</span>
            <strong>Anonimato garantido</strong>
            <span>Suas respostas não são vinculadas ao seu nome em nenhum relatório.</span>
          </div>
          <div class="mini-card">
            <span class="mini-card__ic">⏱</span>
            <strong>≈ 8 minutos</strong>
            <span>Tempo médio para concluir o questionário completo.</span>
          </div>
          <div class="mini-card">
            <span class="mini-card__ic">✓</span>
            <strong>Pode pausar</strong>
            <span>Suas respostas são salvas automaticamente. Volte quando quiser.</span>
          </div>
        </div>
      </section>
